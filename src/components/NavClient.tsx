        ...
        {isLoaded && isSignedIn ? (
          <div className="flex items-center gap-3">
            ...
            <SignOutButton redirectUrl="/">
              <button className="px-3 py-2 text-sm font-medium rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors text-slate-500 dark:text-slate-400">
                Sign out
              </button>
            </SignOutButton>
          </div>
